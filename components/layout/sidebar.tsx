...
export const navItems: NavItem[] = [
  {
    name: 'Dashboard',
    href: '/',
    icon: <PresentationChartBarIcon className={iconClassName} />,
  },
  {
    name: 'Projects',
    href: '/projects',
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        strokeWidth='1.5'
        stroke='currentColor'
        className='size-5 text-neutral-400 group-hover:text-white transition-colors'
      >
        <path
          strokeLinecap='round'
...
const Sidebar = ({ className }: { className: string }) => {
  return <aside className={className}>side nav</aside>
}
