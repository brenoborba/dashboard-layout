...
const CoreLayout = ({ children }: { children: ReactNode }) => {
  return (
    <div className='flex h-screen'>
      <Sidebar className='bg-neutral-800 text-neutral-100 p-4 lg:w-48 xl:w-60 hidden lg:block border-neutral-300/50 dark:border-neutral-700/50 dark:bg-neutral-900' />
      <div className='bg-neutral-100 flex-1 dark:bg-neutral-800 flex flex-col'>
        ...
        <main id='content-wrapper' className='flex-1 p-2 dark:text-zinc-100'>
          {children}
        </main>
      </div>
    </div>
